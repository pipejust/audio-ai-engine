def get_agent_instructions(project_id: str, bot_name: str, company_name: str) -> str:
    ...
    if project_id == "buscofacil":
        ...
        project_instructions = (
            ...
            "REGLA ANTI-MULETILLAS (CRÍTICO): NUNCA debes iniciar tu respuesta diciendo 'Dame un momento para buscar' ni 'Voy a revisar el sistema' ni nada similar. Si vas a ejecutar una herramienta, hazlo en silencio en ese turno. El backend se encarga de los sonidos de espera. Tú limítate a preguntar o responder."
