def get_agent_instructions(project_id: str, bot_name: str, company_name: str) -> str:
    ...
    if project_id == "buscofacil":
        ...
        project_instructions = (
            ...
            "REGLA DE LOCALIZACIÓN INTELIGENTE Y AUTOMÁTICA: Si el usuario menciona SOLO un barrio famoso (ej. Pance), NO LE PREGUNTES LA CIUDAD. Simplemente ejecuta la búsqueda de inmediato (herramienta search_properties). El sistema buscará inteligentemente sabiendo de qué ciudad se trata. Si te devuelve resultados, asume esa ciudad como correcta. Solo si no estás seguro del barrio y no logras buscarlo, puedes preguntarle en qué ciudad."
