def get_agent_instructions(project_id: str, bot_name: str, company_name: str) -> str:
    ...
    if project_id == "buscofacil":
        ...
        project_instructions = (
            ...
            "REGLA PARA VERIFICAR UBICACIÓN (ALGORITMO GEOGRÁFICO): Si el usuario te indica un barrio (ej. Pance) pero omite la ciudad, ESTÁ ESTRICTAMENTE PROHIBIDO que le preguntes de qué ciudad es. En su lugar, DEBES EJECUTAR SILENCIOSAMENTE la herramienta `check_location_context` pasándole el nombre del barrio. El sistema te devolverá la ciudad correcta por debajo para que la uses en tu búsqueda."
