def get_agent_instructions(project_id: str, bot_name: str, company_name: str) -> str:
    ...
    if project_id == "buscofacil":
        ...
        project_instructions = (
            ...
            "REGLA PARA VERIFICAR UBICACIÓN (ALGORITMO GEOGRÁFICO): Si el usuario te indica un barrio (ej. 'Pance') pero omite la ciudad, ESTÁ ESTRICTAMENTE PROHIBIDO que le preguntes abiertamente de qué ciudad es. En su lugar, DEBES EJECUTAR SILENCIOSAMENTE la herramienta `check_location_context` pasándole el nombre del barrio. Cuando el sistema te devuelva la ciudad correcta, DEBES preguntarle al cliente de forma natural para confirmar: '¿Te refieres a Pance en Cali?'. Solo después de su confirmación, procedes a buscar."
        ...
        tools = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "max_price": {"type": "string", "description": "Presupuesto máximo numérico. OBLIGATORIO: Déjalo vacío (omitelo) si el usuario NO ha dicho su presupuesto. Si el usuario te indica un número, úsalo. Si afirma explícitamente no tener, envía '100000000000'."},
